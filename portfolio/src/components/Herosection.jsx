...
const Hero=()=>{
  ...
  <ScrollSectionbottom>
    <h1 className="text-4xl md:text-6xl font-extrabold italiana-regular">Chandran K</h1>
    <h2 className="text-xl md:text-2xl mt-4 font-semibold italiana-regular">Web Developer</h2>
    <p className="mt-4 text-lg text-gray-300">
      I'm a passionate web developer dedicated to creating innovative, responsive websites.
    </p>
...
<div className="md:w-1/2 flex justify-center">
  <ScrollSectionsideright>
    <img src="assets/Profile.png" alt="Chandran K Avatar" className="rounded-full shadow-lg w-48 md:w-64 lg:w-96" />
  </ScrollSectionsideright>
</div>
</div>
